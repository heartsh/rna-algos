...
def main():
  ...
  centroidfold_ppvs_turner = []
  centroidfold_senss_turner = []
  centroidfold_fprs_turner = []
  centroidfold_f1_scores_turner = []
  centroidfold_mccs_turner = []
  centroidfold_ppvs_contra = []
  centroidfold_senss_contra = []
  centroidfold_fprs_contra = []
  centroidfold_f1_scores_contra = []
  centroidfold_mccs_contra = []
  ...
  centroidfold_ss_dir_path_turner = asset_dir_path + "/centroidfold_turner"
  centroidfold_ss_dir_path_contra = asset_dir_path + "/centroidfold_contra"
  ...
  for gamma in gammas:
    ...
    centroidfold_count_params_turner = []
    centroidfold_count_params_contra = []
    ...
    results = pool.map(get_pos_neg_counts, centroidfold_count_params_turner)
    tp, tn, fp, fn = final_sum(results)
    ppv = get_ppv(tp, fp)
    sens = get_sens(tp, fn)
    fpr = get_fpr(tn, fp)
    centroidfold_ppvs_turner.insert(0, ppv)
    centroidfold_senss_turner.insert(0, sens)
    centroidfold_fprs_turner.insert(0, fpr)
    centroidfold_f1_scores_turner.append(get_f1_score(ppv, sens))
    centroidfold_mccs_turner.append(get_mcc(tp, tn, fp, fn))
    results = pool.map(get_pos_neg_counts, centroidfold_count_params_contra)
    tp, tn, fp, fn = final_sum(results)
    ppv = get_ppv(tp, fp)
    sens = get_sens(tp, fn)
    fpr = get_fpr(tn, fp)
    centroidfold_ppvs_contra.insert(0, ppv)
    centroidfold_senss_contra.insert(0, sens)
    centroidfold_fprs_contra.insert(0, fpr)
    centroidfold_f1_scores_contra.append(get_f1_score(ppv, sens))
    centroidfold_mccs_contra.append(get_mcc(tp, tn, fp, fn))
  ...
  line_2, = pyplot.plot(centroid_estimator_contra_ppvs, centroid_estimator_contra_senss, label = "Centroid estimator (CONTRAfold)", marker = "s", linestyle = ":")
  line_3, = pyplot.plot(centroidfold_ppvs_turner, centroidfold_senss_turner, label = "CentroidFold (Turner)", marker = "d", linestyle = "--")
  line_4, = pyplot.plot(centroidfold_ppvs_contra, centroidfold_senss_contra, label = "CentroidFold (CONTRAfold)", marker = "v", linestyle = "-.")
  ...
  line_2, = pyplot.plot(centroid_estimator_contra_fprs, centroid_estimator_contra_senss, label = "Centroid estimator (CONTRAfold)", marker = "s", linestyle = ":")
  line_3, = pyplot.plot(centroidfold_fprs_turner, centroidfold_senss_turner, label = "CentroidFold (Turner)", marker = "d", linestyle = "--")
  line_4, = pyplot.plot(centroidfold_fprs_contra, centroidfold_senss_contra, label = "CentroidFold (CONTRAfold)", marker = "v", linestyle = "-.")
  ...
  line_2, = pyplot.plot(gammas, centroid_estimator_contra_f1_scores, label = "Centroid estimator (CONTRAfold)", marker = "s", linestyle = ":")
  line_3, = pyplot.plot(gammas, centroidfold_f1_scores_turner, label = "CentroidFold (Turner)", marker = "d", linestyle = "--")
  line_4, = pyplot.plot(gammas, centroidfold_f1_scores_contra, label = "CentroidFold (CONTRAfold)", marker = "v", linestyle = "-.")
  ...
  line_2, = pyplot.plot(gammas, centroid_estimator_contra_mccs, label = "Centroid estimator (CONTRAfold)", marker = "s", linestyle = ":")
  line_3, = pyplot.plot(gammas, centroidfold_mccs_turner, label = "CentroidFold (Turner)", marker = "d", linestyle = "--")
  line_4, = pyplot.plot(gammas, centroidfold_mccs_contra, label = "CentroidFold (CONTRAfold)", marker = "v", linestyle = "-.")
  pyplot.xlabel("$\log_2 \gamma$")
  pyplot.ylabel("MCC")
  pyplot.tight_layout()
